...
# accelerometer_sensor = Sensor(address = "10.10.16.27:8080", sensor_type="android.sensor.accelerometer")
gyroscope_sensor = Sensor(address = "10.10.16.27:8080", sensor_type="android.sensor.gyroscope")
# accelerometer_sensor.connect() # asynchronous call
gyroscope_sensor.connect() # asynchronous call
